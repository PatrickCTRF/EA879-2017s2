...
#line 39 "./src/imageprocessing.y" /* yacc.c:1646  */
    {
			...
			imagem I = abrir_imagemCOMBRILHO((yyvsp[-2].strval), (yyvsp[0].valor));
			printf("NÚMERO =  %f\n", (yyvsp[0].valor));
			printf("Li imagem %d por %d\n", I.width, I.height);
...
#line 52 "./src/imageprocessing.y" /* yacc.c:1646  */
    {
			...
			printf("Copiando %s para %s\n", (yyvsp[-2].strval), (yyvsp[-4].strval));
			imagem I = abrir_imagemCOMBRILHO((yyvsp[-2].strval), (1/(yyvsp[0].valor)));
			printf("NÚMERO =  %f\n", (1/(yyvsp[0].valor)));
			printf("Li imagem %d por %d\n", I.width, I.height);
			salvar_imagem((yyvsp[-4].strval), &I);
			liberar_imagem(&I);
...
#line 80 "./src/imageprocessing.y" /* yacc.c:1906  */
