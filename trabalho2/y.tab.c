...
#define DIVIDIDO 263
#define VEZES 264
#define COLCHETEABERTO 265
#define COLCHETEFECHADO 266
#define VALOR 267
#define SOMA 268
...
static const char *const yytname[] =
{
  ...
  "DIVIDIDO", "VEZES", "COLCHETEABERTO", "COLCHETEFECHADO", "VALOR",
...
#line 40 "./src/imageprocessing.y" /* yacc.c:1646  */
    {
			...
			imagem I_processos = abrir_imagemCOMBRILHO_Processos((yyvsp[-2].strval), (yyvsp[0].valor));
			...
			imagem I_threads = abrir_imagemCOMBRILHO_Threads((yyvsp[-2].strval), (yyvsp[0].valor));
			strcpy(str, "_Thread_");
			strcat(str, (yyvsp[-4].strval));
			...
			imagem I_colunas = abrir_imagemCOMBRILHO_Colunas((yyvsp[-2].strval), (yyvsp[0].valor));
			...
			imagem I_linhas = abrir_imagemCOMBRILHO_Linhas((yyvsp[-2].strval), (yyvsp[0].valor));
			strcpy(str, "_Linhas_");
			strcat(str, (yyvsp[-4].strval));
...
#line 101 "./src/imageprocessing.y" /* yacc.c:1646  */
    {
					...
					imagem I = valor_maximo((yyvsp[-1].strval));
